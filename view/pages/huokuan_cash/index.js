...
import { extractBank, getUserInfo,postHuoCashInfo} from '../../api/user.js';
...
Page({
  ...
  */
  ...
  subCash: function (e) {
    ...
    postHuoCashInfo(value).then(res=>{
      that.getUserInfo();
      return app.Tips({ title: res.msg, icon: 'success' }, {tab:5,url:'/pages/user_spread_money/index?type=2'});
    }).catch(err=>{
