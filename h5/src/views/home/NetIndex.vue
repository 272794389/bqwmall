<template>
  <div class="index" v-cloak style="background: #FFFFFF;">
    <div class="header acea-row row-center-wrapper" style="background:#fff;">
      ...
      <router-link :to="'/nsearch'" class="search acea-row row-middle" style="width:96%;">
    ...
    <div class="title acea-row row-between-wrapper" style="width:96%;margin-left:3%;">
        <div class="text">
          <div class="name line1 blabel">佰商荟萃推荐</div>
        </div>
    </div>
    <div class="wrapper" v-if="info.netGoodList">
      <div class="productList" ref="container">
	    ...
	    <div class="morestyle" style="margin-bottom:0.7rem;"><router-link :to="'/wgoods_list/'" >去看更多精挑细选商品&nbsp;></router-link></div>
    </div>
...
export default {
  ...
  mounted: function() {
    ...
    getHomeData().then(res => {
      ...
      that.$set(that, "banner", res.data.nbanner);
