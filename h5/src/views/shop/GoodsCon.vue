<template>
  ...
  >
    ...
    <div id="title0">
      ...
      <div class="title" style="padding-left:0.3rem;float: left;width: 100%;">商家信息<span @click="goDetail(system_store.id)" style="float: right;margin-right: 0.2rem;color: #f00;">进入店铺<span class="iconfont icon-jiantou"></span></span></div>
