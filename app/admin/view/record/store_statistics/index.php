    ...
    (function(){
        var option = {
            ...
            legend: {
                orient: 'vertical',
                x: 'left',
                data:['支付货款','优惠券抵扣','积分抵扣','商家推荐佣金','一代推荐佣金','二代推荐佣金','市级代理商佣金','地区代理商佣金','市级总监佣金','地区总监佣金','运营成本']
            },
            series: [
                {
                    name:'支出',
