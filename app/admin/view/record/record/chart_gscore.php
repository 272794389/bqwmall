        ...
        new Vue({
            ...
            methods: {
                getScoreBadgeList:function(){
                    var that=this;
                    layList.baseGet(layList.U({a:'getGScoreBadgeList',q:{data:this.data}}),function (rem) {
                        that.badge=rem.data;
                    });
                },
                getScoreCurve:function(){
                    var that=this;
                    layList.baseGet(layList.U({a:'getGScoreCurve',q:{data:this.data,limit:this.limit}}),function (rem) {
